        ...
        const response = await fetch(
            url, {
                ...
                body: JSON.stringify({
                    ...
                    "quantity_in_stock": parseInt(productInfo['QuantityInStock']), // 数値に変換
                    "quantity_sold": parseInt(productInfo['QuantitySold']),
                    "unit_price": parseFloat(productInfo['UnitPrice']),
                    "revenue": parseFloat(productInfo['Revenue']),
                }) 
            });
